...
pub async fn handle_antigravity_connect(args: AntigravityArgs) -> ConnectResult {
    ...
    let content = format!(
        "# Isartor — Antigravity integration (base URL override)\n\
         # Source this file: source ~/.isartor/env/antigravity.sh\n\
    ...
    if write_file(&env_path, &content, args.base.dry_run).is_ok() {
        changes.push(ConfigChange {
            ...
            description: "Shell env file with base URL override".to_string(),
        });
    }
