        ...
        let report = render_provider_report(
            ...
            &ProviderStatusResponse {
                ...
                providers: vec![crate::models::ProviderStatusEntry {
                    ...
                    config_url: Some("https://example.invalid".into()),
                    api_key_configured: true,
                    endpoint_configured: true,
                    config_index: None,
                    azure_deployment_id: Some("gpt-4o-mini".into()),
                    azure_api_version: Some("2024-08-01-preview".into()),
                    requests_total: 142,
                    errors_total: 2,
            ...
            get(|| async {
                Json(ProviderStatusResponse {
                    ...
                    providers: vec![crate::models::ProviderStatusEntry {
                        ...
                        config_url: Some("https://api.githubcopilot.com/chat/completions".into()),
                        api_key_configured: true,
                        endpoint_configured: true,
                        config_index: None,
